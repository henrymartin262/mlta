...
KERNEL_SRC="/root/henry/LLM/project/KernelA/asset/linux"
# KERNEL_SRC="/root/henry/kernel/linux-6.5"
...
# NEW_CMD="\n\n\
# KBUILD_USERCFLAGS += -Wno-error -g -Xclang -no-opaque-pointers -Xclang -load -Xclang $IRDUMPER\nKBUILD_CFLAGS += -Wno-error -g -Xclang -no-opaque-pointers -Xclang -load -Xclang $IRDUMPER"
...
cd $KERNEL_SRC && make $CONFIG && make olddefconfig
echo $CLANG
echo $NEW_CMD
